...
function App() {
  ...
  return (
    <>
      <div
        className="universe flex flex-row grow justify-center absolute"
      ...
      >
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/auth"
              element={<Authen isauth={isauth} setisauth={setisauth} />}
            />
            <Route
              path="/selectchat"
              element={
...
<div className="divbtnasd"><p>Or login with:</p></div>
    ...
    <div>
      <div className="hpage ">
        ...
        <div className="quote1">
          <div className="c1 flex flex-row justify-center">
            <div className="d1 flex justify-center">
              {" "}
              Chatting Beyond the Stars{" "}
            </div>
          </div>
          <div className="c1 flex flex-row justify-center">
            <div className="d1 flex justify-center ">OrionChat </div>
          </div>
          <div className="h-4"></div>
        </div>
        <div className="c2 flex flex-row justify-center">
          <div className="d1 flex justify-center ">
            Experience seamless, anonymous connections and vibrant discussions{" "}
          </div>
        </div>
        <div className="c2 flex flex-row justify-center">
          <div className="d1 flex justify-center ">
            designed to bring people together effortlessly{" "}
          </div>
        </div>
        ...
        <div className="flex justify-center">
          <div className="line1 h-0.5 bg-slate-400"></div>
        </div>
        <div className="h-10"></div>
        <div className="h-10"></div>
        ...
        <div className="c2 flex flex-row-reverse justify-center ">
          <div className="a3 flex flex-row-reverse">
            ...
            <div className="d2 flex  px-10 py-11">
              <p>
                {" "}
                Crafting seamless conversations starts with our refined,{" "}
                <span className="bg bg-blue-600">User-friendly Interface</span>,
                ensuring you're in command of every interaction, effortlessly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="h-10"></div>
        <div className="flex justify-center">
          <div className="line2 h-0.5 bg-slate-400"></div>
        </div>
        ...
        <div className="c2 flex flex-row-reverse justify-center ">
          <div className="a3 flex flex-row">
            ...
            <div className="d2 flex  px-10 py-11">
              <p>
                Design captivating online spaces effortlessly. Create <br />
                <span className="bg bg-blue-600">Chat Rooms</span> to connect,
                share, and engage with diverse communities, all within our
                elegant platform
              </p>
            </div>
          </div>
...
{/* 
        <div className="flex justify-center">
          <div className="line3 h-0.5 bg-slate-400"></div>
        </div>
...
const Chat_layout = (props) => {
  ...
  return (
    <div>
      <div
        className="universe flex flex-row grow justify-center absolute"
        style={{ height: "auto", width: "100vw", color: "white" }}
      >
        ...
        <div className="routerdiv flex ">
          {biscuit.get("chat-room") === undefined ? (
            <div className="nochat flex justify-center content-center ">
            ...
            return (
              <div>
                <div className="oiho flex flex-row justify-between flex-grow">
                  ...
                  <div
                    className="click-chat grow"
                    style={{
                      backgroundColor: `${
                        localStorage.getItem("inroom") === roomslist
                          ? "#222627"
                          : ""
                      }`,
                    }}
    ...
    <div className="explore-div-outer sticky top-0">
      <div className="chat-banner-3 ">
        <div className="room-banner-2 flex flex-row justify-center sticky top-0">
          <div></div>
          <p className="roomname rounded-xl p-5 text-xl">Explore</p>
          <div className="out text-xl flex  flex-row justify-center">
            <div className="center  inline-block py-10">{/* <Signout/> */}</div>
          </div>
        </div>
      </div>
  ...
  return (
    <div>
      ...
      <div className="betacards flex flex-row flex-grow ">
        <div className="card-31 card-hover  col grow flex flex-col flex-grow">
          hi
        </div>
        <div className="twin w-4 grow-0"></div>
...
export const Testchatrom = (props) => {
  ...
  const formsubmit = async (e) => {
    ...
    biscuit.get("username")
      ? ""
      : biscuit.set("username", auth.currentUser.displayName);
    await addDoc(msgdbref, {
      text: newmsg,
      createdAt: serverTimestamp(),
      user:
                    ...
                    <div className="msg-container-outline">
                      <div className="img-deco">
                        {messages.msgtype === "image/png" ? (
                          ...
                          <div className={`m-deco rounded-md  `}>
                            {" "}
                            <p
                            ...
                            >
                              ...
                              <p className="mesg-padding">{messages.text}</p>
                            </p>
                          </div>
                        ) : (
                          <a
...
export const SigninWithGoogle = ({ isauth, setisauth }) => {
  ...
  return (
    <div className="auth ">
      <button onClick={googlesignin} className="apple rounded-xl ">
        sign in
      </button>
    </div>
  );
  ...
  return (
    ...
    <>
      ...
      <button
        ...
        className="sout apple bg-black text-white "
      >
        {" "}
        sign out
      </button>
  ...
  return (
    <div>
      <button
        className="button"
        onClick={() => {
          biscuit.set("auth-token", "browsing_anonymously");
          goto("/selectchat");
          setisauth(true);
        }}
      >
  ...
  return (
    <div className="chatroom flex flex-col">
      ...
      <form onSubmit={SendMessage} className="form flex flex-row">
        ...
        <button type="submit" className="button sendbtn text-2xl">
          send
        </button>
      </form>
      <div className="space h-10"></div>
  ...
  return (
    <div className={`message-${messageclass} rounded-xl  flex `}>
      <div className={`lr-${messageclass} flex `}>
        ...
        <div className="space w-5"></div>
        <p
          className={`messsagecnt ${messageclass} text-2xl rounded-xl p-2 text-white`}
        >
          {text}
        </p>
      </div>
